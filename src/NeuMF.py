...
def get_model(num_users, num_items, mf_dim=10, layers=[10], reg_layers=[0], reg_mf=0):
    ...
    MF_Embedding_User = Embedding(input_dim=num_users, output_dim=mf_dim, name="mf_embedding_user",
                                  embeddings_initializer=initializers.he_normal(), embeddings_regularizer=l2(reg_mf),
                                  input_length=1)
    MF_Embedding_Item = Embedding(input_dim=num_items, output_dim=mf_dim,
                                  embeddings_initializer=initializers.he_normal(), name="mf_embedding_item",
    ...
    MLP_Embedding_Item = Embedding(input_dim=num_items, output_dim=layers[0] // 2, name="mlp_embedding_item",
                                   embeddings_initializer=initializers.he_normal(),
                                   embeddings_regularizer=l2(reg_layers[1]), input_length=1)
    ...
    for idx in range(1, num_layer):
        mlp_vector = Dense(layers[idx], activation='sigmoid', kernel_initializer='lecun_uniform', name="layer%d" % idx)(
            mlp_vector)
    ...
    prediction = Dense(units=1, activation='sigmoid', kernel_initializer='lecun_uniform', name="prediction")(
        predict_vector)
...
if __name__ == '__main__':
    ...
    print(model.get_layer('mf_embedding_user').get_weights())
    print(model.summary())
    # Load pretrain model
